          ...
          <div class="col-md-8">
                    ...
                    <tbody>
                        <?php $i = 1; ?>
                          ...
                          <tr>
                              ...
                              <td><button type="submit" class="delete btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal" data-id="<?= $dtl['no_mesin']; ?>"><i class="fas fa-trash"></i> Delete</button></td>
                          </tr>
                          <?php $i++; ?>
                          <?php endforeach; ?>
                    </tbody>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Detail Pengiriman <?php echo date_indo($tanggal_selected); ?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">                
                <table class="table table-striped" id="dataTableUser" width="100%">
                    ...
                    <tbody>
                        <?php $i = 1; ?>
                          <?php foreach ($detail_spg as $dtl_spg) : ?>
                          <tr>
                              <td><?= $i; ?></td>
                              <td><?= $dtl_spg['kode_unit']; ?> - <?= $dtl_spg['warna']; ?></td>
                              <td><?= $dtl_spg['no_mesin']; ?></td>
                              <td><?= $dtl_spg['no_rangka']; ?></td>
                              <td><?= $dtl_spg['no_spg']; ?></td>
                          </tr>
                          <?php $i++; ?>
                          <?php endforeach; ?>
                    </tbody>
  ...
  <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="menuModal" aria-hidden="true">
      <div class="modal-dialog">
          ...
          <form action="<?= base_url('administrator/deletekonsumen'); ?>" method="POST">
            <div class="modal-header">
            <h4 class="modal-title">Yakin ingin menghapus Penjualan ?</h4>
              <input type="hidden" name="no_mesin" id="post-id">
