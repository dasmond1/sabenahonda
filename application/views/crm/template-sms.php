        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="card-header">
                    <h3 class="card-title">Template SMS</h3>
                </div>
                <div class="card-body">
                    <form role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md">
                                <div class="form-group">
                                    <label>Isi Pesan<span class="small"> Max : 160 Character</span></label>
                                    <div class="input-group">
                                        <textarea class="form-control" name="pesan" maxlength="160" rows="4"></textarea>                                    
                                    </div>                                    
                                </div>
      ...
      <div class="modal-dialog">
          ...
          <form action="<?= base_url('crm/delete'); ?>" method="POST">
            <div class="modal-header">
              ...
              <input type="hidden" name="where" value="template_sms">
              <input type="hidden" name="function" value="createtemplatesms">
            </div>
