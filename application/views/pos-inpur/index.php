            ...
            <div class="card">
              ...
              <div class="card-body">                
                <table class="table table-striped" id="dataTableUser" width="100%">
                    ...
                    <tbody>
                    <?php $i = 1; ?>
                <?php foreach ($detail_spg as $key) : ?>
                    <?php $nosin = explode(",", $key['no_mesin']); ?>
                        <?php foreach ($nosin as $ns) : ?>
                        <?php $detail = $this->db->query("SELECT * FROM stok_unit WHERE no_mesin = '$ns'")->row_array(); ?>
                        
                        <tr>
                            <td><?= $i; ?></td>
                            <td><?= $detail['kode_unit']." - ".$detail['warna']; ?></td>
                            <td><?= $ns; ?></td>
          ...
          <div class="col-md-4">
            ...
            <div class="info-box mb-3 bg-warning">
              ...
              <div class="info-box-content">
                ...
                <?php foreach ($kiriman as $key) : ?>
                <?php $nosin = explode(",", $key['no_mesin']); ?>
                <?php foreach ($nosin as $ns) : ?>
                <?php $jmlh = count($nosin); ?>
                <?php endforeach; ?>
                <?php endforeach; ?>
                <span class="info-box-number"><?= $jmlh; ?> Unit</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
            <div class="info-box mb-3 bg-success">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Waktu Unit Di Antar</span>
